...
final List<SpriteAnimationComponent> getBoyComponents = [
  ...
  OrangeBoyComponent(hasCollision: false)
    ..position = Vector2(2018.2507812499875, 597.0710937499988),
  OrangeBoyComponent(hasCollision: false)..position = Vector2(2383.410937499991, 581.5898437499987),
  BlueBoyComponent(
    dialog:
        'Спешу сообщить, что работа над вашим проектом идет уже давно и в ближайшее время будет готова. Однако, не могли бы вы выслать, пожалуйста, пароль от архива с ТЗ?',
  )..position = Vector2(2363.289843749991, 600.3046874999987),
  BrownBoyComponent(hasCollision: false)..position = Vector2(2137.8148437499935, 614.9609374999987),
  BrownBoyComponent(hasCollision: false)
    ..position = Vector2(3004.7874999999935, 407.13281249999875),
];
